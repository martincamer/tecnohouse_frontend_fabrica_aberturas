      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="uppercase text-sm inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <Dialog.Title
                  as="h3"
                  className="text-sm uppercase font-bold leading-6 text-slate-700"
                >
                ...
                >
                  ...
                  <div className="flex">
                    <input
                      className="bg-indigo-100 text-sm font-normal transition-all ease-in-out py-2 px-4 rounded-xl outline-none text-indigo-600 text-center cursor-pointer max-md:text-xs uppercase hover:bg-indigo-500 hover:text-white"
                      type="submit"
