...
export const ModalEditarCategoriasAccesorios = () => {
  const {
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl w-[350px] max-md:w-full">
                ...
                <Dialog.Title
                  as="h3"
                  className="text-sm font-bold uppercase text-slate-700 leading-6 max-md:text-md"
                >
                  Editar categoria
                </Dialog.Title>
                <form
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className="border-gray-300 text-slate-700 border-[1px] py-2 px-2 rounded-xl shadow shadow-black/10 outline-none max-md:text-sm uppercase"
                      type="text"
                  ...
                  <div className="flex flex-col gap-2">
                    <input
                      className="max-md:text-xs bg-indigo-500 text-sm font-normal hover:shadow-black/20 hover:shadow transition-all ease-in-out py-2 px-2 rounded-xl uppercase shadow shadow-black/10 outline-none text-white text-center cursor-pointer"
                      type="submit"
