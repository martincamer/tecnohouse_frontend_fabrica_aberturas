...
export const DescargarPedidoIncompletoJefeFabrica = ({ datos }) => {
  ...
  if (datos && datos.productos?.respuesta) {
    ...
    if (Array.isArray(productosRespuesta) && productosRespuesta.length > 0) {
      // Filtrar productos que cumplan con la nueva condición (cantidad diferente a cantidadFaltante)
      ...
      if (productosFiltrados.length > 0) {
        ...
        console.warn("No hay productos que cumplan con la nueva condición.");
      }
    } else {
      console.error(
